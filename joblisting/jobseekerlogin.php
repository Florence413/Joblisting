        ...
        <div class="row">
          ...
          <div class="col-md-4" style="margin-right:auto;margin-left: auto;">
            <div class="card card-blog">
              ...
              <div class="card-body">
                <h6 class="card-category text-info">Job seeker Login</h6>
          ...
          <div class=" card-login">
            <form class="form" method="post" >
              ...
              <div class="footer text-center">
                <button type="submit" class="btn btn-primary btn-link btn-wd btn-lg" name="btnlogin" id="btnlogin">Job seeker Login</button>
              </div>
              <center>Dont have an account? <a href="jobseekerregister.php">Register here</a></center>
            </form>
          </div>
