...
<?php
 ...
 <?php 
  ...
  {  
     ...
     $sta=$_POST["status"];
     $uid=$_SESSION["id"];
     $sql=mysqli_query($conn,"insert into posts(user_id,user_name,status,status_image,status_time) 
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      ...
      <div id="navbar" class="navbar-collapse collapse">
          <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Pata Job </label>
...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h3 class="modal-title" id="lineModalLabel">What's your Job?</h3>
    </div>
    ...
    <div class="modal-body">
        ...
        <form action="" method="post" enctype="multipart/form-data">  
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Describe your job in more detail</label>
                <div class="row">
    ...
    <!-- Sidebar -->
      <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
          ...
          <li>
            <a href="mytask.php"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> My Job</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="row" style="clear:both">
    <div class="col-lg-12">
      <div class="col-lg-4"><div class="list-group" style="margin-left:0px">
        <a href="user.php" class="list-group-item">Dashboard</a>
        <a href="ourskill.php" class="list-group-item active"  style="background-color:black;">Profile</a>
        <a href="my_task.php" class="list-group-item">My job</a>
        <a href="" data-toggle="modal" data-target="#squarespaceModal" class="list-group-item">Post job</a>
